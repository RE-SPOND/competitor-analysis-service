...
export default function Home() {
  ...
  return <main className="page-shell">
    <header className="topbar"><div><div className="eyebrow">ТЗ 2 / WEB ANALYSIS</div><h1>Автоматизированный конкурентный анализ</h1></div><span className="live-pill"><i /> LIVE DATA</span></header>
