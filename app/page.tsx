...
export default function Home() {
  ...
  return <main className="app-shell">
    <aside className="sidebar"><div className="brand-mark">CA</div><div><b>Competitor<br />Analytics</b><span>research workspace</span></div><nav><a className="active" href="#new"><i>⌂</i> Обзор</a><a href="#new"><i>＋</i> Новый анализ</a><a href="#history"><i>▤</i> Архив анализов <em>{history.length}</em></a></nav><div className="sidebar-note"><i /> Облачная история<br /><small>Upstash подключён</small></div></aside>
    <div className="page-shell"><header className="topbar"><div><div className="breadcrumb">Dashboard <span>/</span> Competitor research</div><h1>Обзор исследований</h1><p>Создавайте анализы, сравнивайте рынок и возвращайтесь к сохранённым выводам.</p></div><div className="header-stats"><span><b>{history.length}</b> анализов</span><span><b>{history.reduce((sum, item) => sum + item.rows.length, 0)}</b> компаний</span><div className="profile-dot">A</div></div></header>
