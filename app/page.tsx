...
export default function Home() {
  ...
  return <main className="app-shell">
    <aside className="sidebar"><div className="brand-mark">CA</div><div><b>Конкурентный<br />анализ</b><span>рабочее пространство</span></div><nav><a href="#new">Новый анализ</a><a href="#history">Архив анализов <em>{history.length}</em></a></nav><div className="sidebar-note"><i /> Облачный архив<br /><small>Анализы сохраняются автоматически</small></div></aside>
    <div className="page-shell"><header className="topbar"><div><div className="section-kicker">Рабочее пространство</div><h1>Конкурентный анализ</h1><p>Запускайте исследование, сравнивайте рынок и возвращайтесь к сохранённым выводам.</p></div><div className="header-stats"><span><b>{history.length}</b> сохранено</span><span><b>{history.reduce((sum, item) => sum + item.rows.length, 0)}</b> компаний в архиве</span></div></header>
